...
class VDU(pyglet.window.Window):
    ...
    def inkey(self, char):
        if char == "LEFT":
            return self.key_state(key.LEFT)
        elif char == "RIGHT":
            return self.key_state(key.RIGHT)
        elif char == "UP":
            return self.key_state(key.UP)
        elif char == "DOWN":
            return self.key_state(key.DOWN)
        elif char == "ENTER":
            return self.key_state(key.ENTER)
        else:
            return self.key_state(ord(char))
